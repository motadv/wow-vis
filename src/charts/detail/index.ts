...
export function initDetail(
  ...
  subscribe((state) => {
    ...
    Object.assign(dot.style, {
      ...
      height: "10px",
      borderRadius: "50%",
      background: ERA_PALETTE[dungeon.era],
      flexShrink: "0",
    ...
    Object.assign(badge.style, {
      ...
      padding: "2px 6px",
      borderRadius: "4px",
      background: `${ERA_PALETTE[dungeon.era]}33`,
      color: ERA_PALETTE[dungeon.era],
      flexShrink: "0",
    });
    ...
    if (viewMode === "era") {
      ...
      renderReintroductionView(
        chartArea,
        dungeon,
        buildSnapshots(dungeon.id, manifest),
      );
    }
  });
}
